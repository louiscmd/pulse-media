...
const STATUS_CONFIG: Record<string, { label: string; color: string; bg: string }> = {
  ...
  awaiting_review: { label: 'Awaiting Review', color: '#1DD9C5', bg: 'rgba(29,217,197,0.13)' },
  ...
  in_editing: { label: 'In Editing', color: '#1DD9C5', bg: 'rgba(29,217,197,0.13)' },
  ready_to_post: { label: 'Ready to Post', color: '#5ce6a8', bg: 'rgba(92,230,168,0.14)' },
  posted: { label: 'Posted', color: '#526460', bg: 'rgba(82,100,96,0.12)' },
  // Edit statuses
  in_review: { label: 'In Review', color: '#1DD9C5', bg: 'rgba(29,217,197,0.13)' },
